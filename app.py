...
def submit_form():
    if request.method == 'POST':
        ...
        if not (firstname.isalpha() and lastname.isalpha()):
            return "Error: Firstname and lastname should contain only alphabetic characters.", 400
...
def admin_login():
    if request.method == 'POST':
        ...
        if admin and check_password_hash(admin.password, password):
            ...
            return redirect(url_for('view_submissions'))  # Redirect to the forms view or another page
        else:
